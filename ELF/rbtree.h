...
extern void rb_replace_node_rcu(struct rb_node *victim, struct rb_node *new_node, struct rb_root *root);
...
static inline void rb_replace_node_cached(struct rb_node *victim, struct rb_node *new_node, struct rb_root_cached *root)
{
