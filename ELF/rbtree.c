...
static inline void __rb_change_child(struct rb_node *old, struct rb_node *new_node, struct rb_node *parent, struct rb_root *root)
{
    if (parent) {
...
static inline void __rb_change_child_rcu(struct rb_node *old, struct rb_node *new_node, struct rb_node *parent, struct rb_root *root)
{
    if (parent) {
        if (parent->rb_left == old)
 ...
 */
static inline void __rb_rotate_set_parents(struct rb_node *old, struct rb_node *new_node, struct rb_root *root, int color)
{
...
static __always_inline void __rb_insert(struct rb_node *node, struct rb_root *root, void (*augment_rotate)(struct rb_node *old, struct rb_node *new_node))
{
 ...
 */
static __always_inline void ____rb_erase_color(struct rb_node *parent, struct rb_root *root, void (*augment_rotate)(struct rb_node *old, struct rb_node *new_node))
{
...
void __rb_erase_color(struct rb_node *parent, struct rb_root *root, void (*augment_rotate)(struct rb_node *old, struct rb_node *new_node))
{
...
void __rb_insert_augmented(struct rb_node *node, struct rb_root *root, void (*augment_rotate)(struct rb_node *old, struct rb_node *new_node))
{
...
void rb_replace_node_rcu(struct rb_node *victim, struct rb_node *new_node, struct rb_root *root)
{
    struct rb_node *parent = rb_parent(victim);
    ...
    *new_node = *victim;
     ...
     */
    __rb_change_child_rcu(victim, new_node, parent, root);
}
